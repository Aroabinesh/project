...
//                 <Link to="/StuComp" className="nav-link" activeClassName="active" style={{color:'white',backgroundColor:'black', fontFamily:'sans-serif'}}>
//                 <FaUserCheck style={{ margin: '0px 5px 4px 0px' }} />Institue Management
//                 </Link>
//               </li>
...
const RoutingModuleComp = () => {
  return (
    <div className="container-fluid">
      <div className="row flex-nowrap">
        <div className="col-auto col-md-3 col-xl-2 px-sm-0 px-0 bg-dark" style={{ padding: '0', margin: '0' }}>
          <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li className="nav-item" style={{marginTop:'8px'}}>
                <Link to="/StuComp" className="nav-link" activeClassName="active" style={{color:'white',fontFamily:'sans-serif'}}>
